...
angular
  .module('timeclubAngularApp', [
   ...
   .config(function ($stateProvider, $urlRouterProvider, localStorageServiceProvider) {
    ...
    .run(['$rootScope', '$location', '$http', 'User','localStorageService','textConsts',
        function ($rootScope, $location, $http, User, localStorageService,textConsts) {
        ...
        if(localStorageService.isSupported) {//fetch from local storage
            ...
            //console.log("user details fetched from local storage to rootScope: currentUserName="+ $rootScope.currentUserName + "; isAdmin="+$rootScope.isAdmin);
          };
